...
/*
|--------------------------------------------------------------------------
| Configuración de bases de datos del servicio de autenticación
|--------------------------------------------------------------------------
|
...
| caché y colas.
|
| El auth-service usa PostgreSQL como base principal (angelow_auth)
| porque la PK de usuarios es string(20) para compatibilidad legacy.
|
*/
