...
- [Descripción paso a paso del desarrollo:](#descripción-paso-a-paso-del-desarrollo)
- [Resumen del proyecto:](#resumen-del-proyecto)
- [Evidencias visuales (pantallazos) del sistema, incluyendo colores, diseño y estado actual de la interfaz:](#evidencias-visuales-pantallazos-del-sistema-incluyendo-colores-diseño-y-estado-actual-de-la-interfaz)
- [Tecnologías utilizadas: base de datos, lenguaje de programación y framework implementado:](#tecnologías-utilizadas-base-de-datos-lenguaje-de-programación-y-framework-implementado)
<!-- indice:auto:end -->
