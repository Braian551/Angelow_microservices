...
- [1) Arquitectura de contenedores (Docker Compose)](#1-arquitectura-de-contenedores-docker-compose)
- [2) Frontend modular y capa API](#2-frontend-modular-y-capa-api)
- [3) Dependencias entre microservicios](#3-dependencias-entre-microservicios)
- [4) Secuencia checkout, pago y confirmacion](#4-secuencia-checkout-pago-y-confirmacion)
<!-- indice:auto:end -->
