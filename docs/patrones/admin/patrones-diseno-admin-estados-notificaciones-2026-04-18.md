...
- [Problema](#problema)
- [Patrón 1: Adapter (traducción de estados de dominio a UI)](#patrón-1-adapter-traducción-de-estados-de-dominio-a-ui)
- [Patrón 2: Observer + Event Aggregation (polling con consolidación de eventos)](#patrón-2-observer-event-aggregation-polling-con-consolidación-de-eventos)
- [Patrón 3: Single Source of Truth para estados en filtros/acciones](#patrón-3-single-source-of-truth-para-estados-en-filtros-acciones)
