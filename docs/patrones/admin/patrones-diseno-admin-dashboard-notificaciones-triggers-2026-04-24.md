...
- [4) Observer (implementación orientada a eventos de dominio)](#4-observer-implementación-orientada-a-eventos-de-dominio)
- [5) Memento](#5-memento)
- [Resultado funcional validado](#resultado-funcional-validado)
<!-- indice:auto:end -->
