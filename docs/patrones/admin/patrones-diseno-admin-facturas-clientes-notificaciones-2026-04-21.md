...
- [Contexto](#contexto)
- [Patrón 1: Adapter (hidratación de identidad cross-service)](#patrón-1-adapter-hidratación-de-identidad-cross-service)
- [Patrón 2: Strategy (selección de fuente de orden durante migración)](#patrón-2-strategy-selección-de-fuente-de-orden-durante-migración)
- [Patrón 3: Guard Clauses (facturación robusta y notificación)](#patrón-3-guard-clauses-facturación-robusta-y-notificación)
- [Ajuste técnico adicional (compatibilidad de columna invoice_number)](#ajuste-técnico-adicional-compatibilidad-de-columna-invoicenumber)
