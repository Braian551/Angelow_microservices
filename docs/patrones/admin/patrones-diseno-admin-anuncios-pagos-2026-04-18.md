...
- [Patrón 1: Strategy (selección de fuente de datos)](#patrón-1-strategy-selección-de-fuente-de-datos)
- [Patrón 2: Fail-Safe / Null Object pragmático para consulta opcional](#patrón-2-fail-safe-null-object-pragmático-para-consulta-opcional)
- [Patrón 3: Repository simplificado sobre Query Builder](#patrón-3-repository-simplificado-sobre-query-builder)
- [Evidencia de datos iniciales idempotentes](#evidencia-de-datos-iniciales-idempotentes)
- [Resultado esperado en UI](#resultado-esperado-en-ui)
- [Patrón 4: Compensating Action pragmática para sincronización pago-orden](#patrón-4-compensating-action-pragmática-para-sincronización-pago-orden)
- [Extensión 2026-05-10: formulario adaptable por tipo de anuncio](#extensión-2026-05-10-formulario-adaptable-por-tipo-de-anuncio)
  - [Patrón 5: Strategy de variantes de formulario](#patrón-5-strategy-de-variantes-de-formulario)
<!-- indice:auto:end -->
