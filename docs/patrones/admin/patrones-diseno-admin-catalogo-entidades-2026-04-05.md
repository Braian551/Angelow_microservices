...
- [Patron 2: Template Method en flujos CRUD ligeros](#patron-2-template-method-en-flujos-crud-ligeros)
- [Patron 3: Adapter para respuesta heterogenea de datos](#patron-3-adapter-para-respuesta-heterogenea-de-datos)
- [Patron 4: Command orientado a acciones de inventario](#patron-4-command-orientado-a-acciones-de-inventario)
- [Patron 5: Repository informal via controlador admin](#patron-5-repository-informal-via-controlador-admin)
- [Resultado](#resultado)
<!-- indice:auto:end -->
