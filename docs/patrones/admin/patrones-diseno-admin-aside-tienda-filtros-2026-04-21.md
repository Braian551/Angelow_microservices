...
- [Patrón 1: Adapter (normalización de filtros de UI a API)](#patrón-1-adapter-normalización-de-filtros-de-ui-a-api)
- [Patrón 2: State (estado visual del aside basado en settings)](#patrón-2-state-estado-visual-del-aside-basado-en-settings)
- [Patrón 3: Guard Clauses (fallback seguro cuando legacy no está disponible)](#patrón-3-guard-clauses-fallback-seguro-cuando-legacy-no-está-disponible)
- [Resultado esperado](#resultado-esperado)
- [Ajuste de corrección (misma fecha)](#ajuste-de-corrección-misma-fecha)
  - [Patrón adicional: Adapter (normalización robusta de género)](#patrón-adicional-adapter-normalización-robusta-de-género)
  - [Patrón adicional: State (apertura/cierre de filtros resistente a colisión CSS)](#patrón-adicional-state-apertura-cierre-de-filtros-resistente-a-colisión-css)
  - [Patrón adicional: Decorator (scrollbar aplicado al contenedor correcto)](#patrón-adicional-decorator-scrollbar-aplicado-al-contenedor-correcto)
- [Ajuste visual adicional de tienda e inicio (misma fecha)](#ajuste-visual-adicional-de-tienda-e-inicio-misma-fecha)
  - [Patrón adicional: State (filtros colapsables con estado explícito)](#patrón-adicional-state-filtros-colapsables-con-estado-explícito)
  - [Patrón adicional: Adapter (normalización de rango de precios para URL y API)](#patrón-adicional-adapter-normalización-de-rango-de-precios-para-url-y-api)
  - [Patrón adicional: Facade (componente de paginación para catálogo)](#patrón-adicional-facade-componente-de-paginación-para-catálogo)
  - [Patrón adicional: Parameter Object (límite explícito en destacados de inicio)](#patrón-adicional-parameter-object-límite-explícito-en-destacados-de-inicio)
<!-- indice:auto:end -->
