...
- [3) Adapter](#3-adapter)
- [4) Reuse Component / Composition](#4-reuse-component-composition)
- [5) Guard Clause (Fail-Fast) sobre estrategia de correo](#5-guard-clause-fail-fast-sobre-estrategia-de-correo)
- [Archivos impactados por esta implementación](#archivos-impactados-por-esta-implementación)
- [Extensión 2026-04-17: campaña específica en vista dedicada (sin modal)](#extensión-2026-04-17-campaña-específica-en-vista-dedicada-sin-modal)
  - [6) Facade + Composition](#6-facade-composition)
- [Mejora UX 2026-05-10: rediseño de layout campaña a usuarios específicos](#mejora-ux-2026-05-10-rediseño-de-layout-campaña-a-usuarios-específicos)
  - [7) Presentación por pasos (Step UI) + Extracción de barra de acción](#7-presentación-por-pasos-step-ui-extracción-de-barra-de-acción)
  - [7) Command](#7-command)
- [Extensión 2026-05-10: prioridad visual del snackbar y código automático](#extensión-2026-05-10-prioridad-visual-del-snackbar-y-código-automático)
  - [8) State](#8-state)
  - [9) Composition](#9-composition)
- [Extensión 2026-05-10: prevalidación de destinatarios en campaña masiva](#extensión-2026-05-10-prevalidación-de-destinatarios-en-campaña-masiva)
