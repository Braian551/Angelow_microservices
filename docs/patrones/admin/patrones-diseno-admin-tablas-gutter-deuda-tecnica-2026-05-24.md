...
- [Patrón 1: Flyweight (comportamiento compartido del wrapper de tablas)](#patrón-1-flyweight-comportamiento-compartido-del-wrapper-de-tablas)
- [Ajuste de mantenimiento: gobernanza de deuda técnica local](#ajuste-de-mantenimiento-gobernanza-de-deuda-técnica-local)
