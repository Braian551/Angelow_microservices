...
- [Problema](#problema)
- [Patrón 1: Adapter (normalización de texto para búsqueda tolerante)](#patrón-1-adapter-normalización-de-texto-para-búsqueda-tolerante)
- [Patrón 2: Null Object (fallback de fecha operativa)](#patrón-2-null-object-fallback-de-fecha-operativa)
- [Patrón 3: Decorator (mejora visual sin romper estructura existente)](#patrón-3-decorator-mejora-visual-sin-romper-estructura-existente)
