...
- [2) Adapter](#2-adapter)
- [3) Command](#3-command)
- [Archivos impactados por la implementacion](#archivos-impactados-por-la-implementacion)
- [Dependencias](#dependencias)
- [Extension 2026-04-12: acciones rapidas y desactivacion en listado](#extension-2026-04-12-acciones-rapidas-y-desactivacion-en-listado)
- [Extension 2026-04-15: direccion enriquecida en detalle de orden](#extension-2026-04-15-direccion-enriquecida-en-detalle-de-orden)
- [Extension 2026-04-15: reorganizacion visual del resumen de orden](#extension-2026-04-15-reorganizacion-visual-del-resumen-de-orden)
- [Extension 2026-04-15: reorganizacion visual de direccion, comprobante y productos](#extension-2026-04-15-reorganizacion-visual-de-direccion-comprobante-y-productos)
- [Extension 2026-04-15: coherencia del contrato de direccion en tarjeta y modal](#extension-2026-04-15-coherencia-del-contrato-de-direccion-en-tarjeta-y-modal)
- [Extensión 2026-04-17: notificación interna + correo al cambiar estado/pago](#extensión-2026-04-17-notificación-interna-correo-al-cambiar-estado-pago)
- [Extensión 2026-04-17: facturación automática + bandeja admin de facturas](#extensión-2026-04-17-facturación-automática-bandeja-admin-de-facturas)
- [Extensión 2026-04-17: notificaciones de órdenes + flujo de reembolso visible](#extensión-2026-04-17-notificaciones-de-órdenes-flujo-de-reembolso-visible)
<!-- indice:auto:end -->
