...
- [Contexto](#contexto)
- [Patrón 1: Strategy (rango independiente por gráfico)](#patrón-1-strategy-rango-independiente-por-gráfico)
- [Patrón 2: Adapter (traducción homogénea de estados técnicos)](#patrón-2-adapter-traducción-homogénea-de-estados-técnicos)
- [Patrón 3: Command / Navigation Intent (tarjetas clicables con destino explícito)](#patrón-3-command-navigation-intent-tarjetas-clicables-con-destino-explícito)
- [Patrón 4: Null Object / Empty State (respuesta explícita cuando el reporte viene vacío)](#patrón-4-null-object-empty-state-respuesta-explícita-cuando-el-reporte-viene-vacío)
