...
- [Problema](#problema)
- [Patrón 1: Single Source of Truth para stock efectivo admin](#patrón-1-single-source-of-truth-para-stock-efectivo-admin)
  - [Qué resuelve](#qué-resuelve)
  - [Archivos aplicados](#archivos-aplicados)
  - [Aplicación](#aplicación)
- [Patrón 2: Observer liviano para alertas de inventario](#patrón-2-observer-liviano-para-alertas-de-inventario)
  - [Qué resuelve](#qué-resuelve-2)
  - [Archivos aplicados](#archivos-aplicados-2)
  - [Aplicación](#aplicación-2)
- [Patrón 5: Deep Link interno para reparar la variante exacta](#patrón-5-deep-link-interno-para-reparar-la-variante-exacta)
  - [Qué resuelve](#qué-resuelve-3)
  - [Archivos aplicados](#archivos-aplicados-3)
  - [Aplicación](#aplicación-3)
- [Patrón 3: State + Scheduler para agotados persistentes y recordatorios](#patrón-3-state-scheduler-para-agotados-persistentes-y-recordatorios)
  - [Qué resuelve](#qué-resuelve-4)
  - [Archivos aplicados](#archivos-aplicados-4)
  - [Aplicación](#aplicación-4)
- [Patrón 4: Adapter para simplificar estados de órdenes en admin](#patrón-4-adapter-para-simplificar-estados-de-órdenes-en-admin)
  - [Qué resuelve](#qué-resuelve-5)
  - [Archivos aplicados](#archivos-aplicados-5)
  - [Aplicación](#aplicación-5)
- [Resultado](#resultado)
<!-- indice:auto:end -->
