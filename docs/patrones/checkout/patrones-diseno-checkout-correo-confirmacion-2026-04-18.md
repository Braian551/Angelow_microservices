...
- [Problema](#problema)
- [Patrón 1: Chain of Responsibility (resolución de correo destinatario)](#patrón-1-chain-of-responsibility-resolución-de-correo-destinatario)
- [Patrón 2: Fail Fast + Validación en tiempo real](#patrón-2-fail-fast-validación-en-tiempo-real)
