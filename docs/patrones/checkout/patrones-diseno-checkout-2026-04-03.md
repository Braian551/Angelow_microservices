...
- [Adapter](#adapter)
- [Adapter (refuerzo de robustez en confirmación de pago)](#adapter-refuerzo-de-robustez-en-confirmación-de-pago)
- [Adapter (traducción de errores técnicos de inventario)](#adapter-traducción-de-errores-técnicos-de-inventario)
- [Adapter (contrato de variantes carrito -> checkout)](#adapter-contrato-de-variantes-carrito---checkout)
- [State](#state)
