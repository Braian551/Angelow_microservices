...
- [Patrón 1: Strategy para serialización de request](#patrón-1-strategy-para-serialización-de-request)
- [Patrón 2: Adapter de mensajes técnicos a copy de usuario](#patrón-2-adapter-de-mensajes-técnicos-a-copy-de-usuario)
