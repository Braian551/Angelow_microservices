...
- [Patrón 1: Strategy (selección de fuente de datos con fallback)](#patrón-1-strategy-selección-de-fuente-de-datos-con-fallback)
- [Patrón 2: Facade de integración para exposición pública de anuncios](#patrón-2-facade-de-integración-para-exposición-pública-de-anuncios)
- [Patrón 3: Guard Clauses para control de stock en tiempo real](#patrón-3-guard-clauses-para-control-de-stock-en-tiempo-real)
- [Patrón 4: Single Source of Truth para stock disponible en frontend catálogo](#patrón-4-single-source-of-truth-para-stock-disponible-en-frontend-catálogo)
