...
- [Patrón 1: State (control explícito de estados de carga de imagen)](#patrón-1-state-control-explícito-de-estados-de-carga-de-imagen)
- [Patrón 2: Observer (reacción a cambios de configuración/ruta)](#patrón-2-observer-reacción-a-cambios-de-configuración-ruta)
- [Patrón 3: Flyweight (tokens de estilo compartidos para scrollbars)](#patrón-3-flyweight-tokens-de-estilo-compartidos-para-scrollbars)
- [Ajuste funcional complementario](#ajuste-funcional-complementario)
