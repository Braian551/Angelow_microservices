...
- [Contexto](#contexto)
- [1) Decorator (Decorador)](#1-decorator-decorador)
- [2) State (Estado) — visual](#2-state-estado-visual)
- [3) Composite (Compuesto) — tarjetas de reseñas](#3-composite-compuesto-tarjetas-de-reseñas)
- [4) Composite — tarjetas de preguntas y respuestas](#4-composite-tarjetas-de-preguntas-y-respuestas)
