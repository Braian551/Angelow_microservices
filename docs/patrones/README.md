...
- [2026-04-17 - Códigos de descuento y descuentos por cantidad funcionales](#2026-04-17---códigos-de-descuento-y-descuentos-por-cantidad-funcionales)
- [2026-04-17 - Ajuste de prioridad en total de envío (base + rango)](#2026-04-17---ajuste-de-prioridad-en-total-de-envío-base-rango)
- [2026-04-16 - Paridad de envíos en checkout + imagen en productos de orden](#2026-04-16---paridad-de-envíos-en-checkout-imagen-en-productos-de-orden)
- [2026-04-16 - Cuenta de pago compartida y estado sincronizado entre pagos y órdenes](#2026-04-16---cuenta-de-pago-compartida-y-estado-sincronizado-entre-pagos-y-órdenes)
- [2026-04-15 - Limpieza de copy técnico visible en admin](#2026-04-15---limpieza-de-copy-técnico-visible-en-admin)
- [2026-04-14 - Refresco en caliente de ajustes e imágenes admin](#2026-04-14---refresco-en-caliente-de-ajustes-e-imágenes-admin)
- [2026-04-14 - Drag and Drop para orden de sliders](#2026-04-14---drag-and-drop-para-orden-de-sliders)
- [2026-04-14 - Ajustes generales proyectados al sitio](#2026-04-14---ajustes-generales-proyectados-al-sitio)
- [2026-04-14 - Fallback legacy para envios admin](#2026-04-14---fallback-legacy-para-envios-admin)
- [2026-04-14 - Responsive transversal para header y filtros admin](#2026-04-14---responsive-transversal-para-header-y-filtros-admin)
- [2026-04-14 - Paginación reusable para vistas admin](#2026-04-14---paginación-reusable-para-vistas-admin)
- [2026-04-14 - Redireccion inicial por rol y guard de rutas admin/cuenta](#2026-04-14---redireccion-inicial-por-rol-y-guard-de-rutas-admin-cuenta)
- [2026-04-12 - Unificación visual de filtros admin + protocolo anti-caché frontend](#2026-04-12---unificación-visual-de-filtros-admin-protocolo-anti-caché-frontend)
- [2026-04-02 - Favoritos (CORS) + Carrito (paridad legacy)](#2026-04-02---favoritos-cors-carrito-paridad-legacy)
- [2026-04-03 - Resumen/Favoritos + Ajuste visual configuración](#2026-04-03---resumen-favoritos-ajuste-visual-configuración)
- [2026-04-03 - Reintegración de recomendaciones + paridad visual pedidos/carrito](#2026-04-03---reintegración-de-recomendaciones-paridad-visual-pedidos-carrito)
- [2026-04-03 - Buscador global + detalle de pedido funcional](#2026-04-03---buscador-global-detalle-de-pedido-funcional)
- [2026-04-03 - Paridad carrito/checkout + feedback visual de compra](#2026-04-03---paridad-carrito-checkout-feedback-visual-de-compra)
- [2026-04-03 - Graficos dashboard e informes admin (paridad legacy)](#2026-04-03---graficos-dashboard-e-informes-admin-paridad-legacy)
- [2026-04-03 - Alineación de endpoints admin con BD distribuida](#2026-04-03---alineación-de-endpoints-admin-con-bd-distribuida)
- [2026-04-03 - Paridad visual productos admin + datos reales dashboard](#2026-04-03---paridad-visual-productos-admin-datos-reales-dashboard)
- [2026-04-03 - Paridad del carrito microservicios con Angelow](#2026-04-03---paridad-del-carrito-microservicios-con-angelow)
- [2026-04-03 - Corrección de aside admin (estado activo + avatar fallback)](#2026-04-03---corrección-de-aside-admin-estado-activo-avatar-fallback)
...
- Problema resuelto: confirmar stock real en PostgreSQL al aprobar pago sin romper APIs publicas existentes.

## 2026-04-17 - Cancelación de pedidos de cliente, reembolso asistido y actualización en vivo
...
- Referencia detallada:
	docs/patrones/admin/patrones-diseno-admin-descuentos-2026-04-17.md
