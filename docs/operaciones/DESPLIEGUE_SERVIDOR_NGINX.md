...
- [3. Crear estructura del proyecto](#3-crear-estructura-del-proyecto)
- [4. Crear `.env` raíz del servidor](#4-crear-env-raíz-del-servidor)
- [5. Subir el código desde Windows](#5-subir-el-código-desde-windows)
- [6. PostgreSQL init](#6-postgresql-init)
- [7. Frontend en producción](#7-frontend-en-producción)
- [8. Nginx interno de Docker](#8-nginx-interno-de-docker)
- [9. `docker-compose.yml` de producción](#9-docker-composeyml-de-producción)
- [10. Nginx del host](#10-nginx-del-host)
- [11. SSL con Certbot](#11-ssl-con-certbot)
- [12. Construir y levantar contenedores](#12-construir-y-levantar-contenedores)
- [13. Migraciones y caches](#13-migraciones-y-caches)
- [14. Subir uploads](#14-subir-uploads)
- [15. Migrar datos PostgreSQL](#15-migrar-datos-postgresql)
- [16. Verificación final](#16-verificación-final)
- [17. Problemas comunes](#17-problemas-comunes)
  - [Error 419 CSRF en login](#error-419-csrf-en-login)
